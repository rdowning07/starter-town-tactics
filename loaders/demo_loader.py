...
def load_state(scenario_path: str) -> GameState:
    ...
    if os.path.exists(scenario_path):
        try:
            game_state = _load_from_scenario_file(scenario_path, game_state, 
                                                sprite_manager, fx_manager, sound_manager)
        except Exception as e:
...
def _load_from_scenario_file(scenario_path: str, game_state: GameState,
                           sprite_manager: SpriteManager, fx_manager: FXManager, 
                           sound_manager: SoundManager) -> GameState:
