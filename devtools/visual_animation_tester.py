...
def main():
    ...
    print(f"🎬 Visual Animation Tester")
    ...
    try:
        ...
        # Initialize sprite manager, sound manager, fx manager, and renderer
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        frame_index = 0
                        frame_timer = 0
                        sound_manager.play("select")  # Play selection sound
                        if not load_current_animation():
                            continue
            ...
            info_lines = [
                ...
                "",
                f"Controls: SPACE=Switch, A=Auto, ←→=Frame, ESC=Quit"
            ]
