...
class ScenarioManager:
    ...
    def _is_battle_won(self) -> bool:
        ...
        enemy_units = [name for name, data in self.game_state.units.get_all_units().items() 
    ...
    def _is_battle_lost(self) -> bool:
        ...
        player_units = [name for name, data in self.game_state.units.get_all_units().items() 
