...
def create_asset_structure():
    ...
    asset_structure = {
        ...
        "assets/tiles/elevation": ["level_1.png", "level_2.png", "level_3.png"],
        "assets/tiles/special": ["lava.png", "ice.png", "portal.png"],
        "assets/tiles/academy": [
            "floor.png",
            "wall.png",
            "door.png",
            "window.png",
        ...
        "assets/units/knight": ["blue.png", "red.png", "neutral.png"],
        "assets/units/archer": ["blue.png", "red.png"],
        "assets/units/mage": ["blue.png", "red.png"],
        "assets/units/goblin": ["ai.png"],
        "assets/units/ai": ["boss.png", "minion.png"],
        "assets/units/recruit": ["blue.png", "red.png", "neutral.png"],
        "assets/units/soulblade": ["blue.png", "red.png", "neutral.png"],
        "assets/units/void_revenant": ["blue.png", "red.png", "neutral.png"],
        "assets/units/phoenix_binder": ["blue.png", "red.png", "neutral.png"],
        "assets/units/crystal_archon": ["blue.png", "red.png", "neutral.png"],
        "assets/ui/cursors": ["normal.png", "select.png", "attack.png"],
        "assets/ui/icons": ["health.png", "ap.png", "move.png", "attack.png"],
        "assets/ui/panels": ["healthbar.png", "menu_bg.png", "button.png"],
        "assets/effects/particles": ["attack.png", "heal.png", "death.png"],
        "assets/effects/summoning": ["portal.png", "sparkle.png", "energy.png"],
        "assets/effects/aura": ["buff.png", "debuff.png", "shield.png"],
