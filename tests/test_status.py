...
class TestPoisonEffect:
    ...
    def setup_method(self):
        ...
        self.unit = Unit(
            unit_id="poisoned_unit",
            pos=(2, 2),
            stats=UnitStats(hp=10, atk=5, def_=2),
            team="player"
        )
...
class TestSlowEffect:
    ...
    def setup_method(self):
        ...
        self.unit = Unit(
            unit_id="slow_unit",
            pos=(3, 3),
            stats=UnitStats(hp=15, atk=6, def_=3),
            team="player"
        )
...
class TestStatusIntegration:
    ...
    def test_multiple_units_with_status(self):
        ...
        # Poisoned unit
        poisoned = Unit(
            "poisoned", (1, 1), stats=UnitStats(hp=10, atk=5, def_=2),
            team="player"
        )
        ...
        # Slowed unit  
        slowed = Unit(
            "slowed", (2, 2), stats=UnitStats(hp=12, atk=6, def_=3),
            team="player"
        )
        ...
        # Normal unit
        normal = Unit(
            "normal", (3, 3), stats=UnitStats(hp=15, atk=7, def_=2),
            team="player"
        )
        normal.status = []
    ...
    def test_status_removal(self):
        ...
        unit = Unit(
            "unit", (1, 1), stats=UnitStats(hp=10, atk=5, def_=2),
            team="player"
        )
