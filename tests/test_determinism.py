...
def create_test_scenario(seed=1337):
    ...
    # Create units
    player = Unit(unit_id="player1", pos=(2, 2), stats=UnitStats(hp=20, atk=8, def_=3, h=0), team="player")

    enemy = Unit(unit_id="enemy1", pos=(6, 6), stats=UnitStats(hp=15, atk=6, def_=2, h=0), team="enemy")
    ...
    objective_config = {
        "type": "Compound",
        "list": [{"type": "EliminateBoss", "boss_id": "enemy1"}, {"type": "SurviveNTurns", "n": 5}],
    }
