from game.gamepad_controller import GamepadController, UP_BUTTON, DOWN_BUTTON, LEFT_BUTTON, RIGHT_BUTTON, CONFIRM_BUTTON, CANCEL_BUTTON
...
def test_gamepad_confirm_button_confirms_selection(monkeypatch):
    ...
    controller = GamepadController(input_state)
    called = {}
    def fake_confirm(): called['yes'] = True
...
def test_gamepad_cancel_button_cancels_selection(monkeypatch):
    ...
    controller = GamepadController(input_state)
    called = {}
    def fake_cancel(): called['yes'] = True
