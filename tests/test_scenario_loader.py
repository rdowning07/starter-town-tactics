...
def test_validate_scenario_units_not_list(scenario_loader):
    ...
    scenario_data = {"name": "Test", "units": "not a list"}
...
def test_validate_unit_invalid_team(scenario_loader):
    ...
    unit_data = {"name": "Test Unit", "team": "invalid_team", "sprite": "knight", "x": 5, "y": 5}
...
def test_validate_unit_invalid_coordinates(scenario_loader):
    ...
    unit_data = {"name": "Test Unit", "team": "player", "sprite": "knight", "x": "not an int", "y": 5}
...
def test_camera_integration(
    scenario_loader, sprite_manager, fx_manager, sound_manager, camera_mock, valid_scenario_yaml
):
