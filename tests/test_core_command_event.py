...
from core import Attack, Command, Controller, EndTurn, Event, EventBus, GameLoop, GameState, Move, Rng, Subscriber
    ...
    def test_full_command_event_flow(self):
        ...
        class TestMoveCommand:
            ...
            def apply(self, s: GameState) -> List[Event]:
                ...
                return [Event(type=EventType.UNIT_MOVED, payload={"unit_id": self.unit_id, "to": self.to}, tick=s.tick)]
