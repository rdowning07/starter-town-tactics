...
"""
import pytest
from core.rules.combat import (
    apply_attack, calc_height_bonus, calc_facing_bonus, DamageResult
)
...
class TestDamageCalculation:
    ...
    def setup_method(self):
        ...
        self.attacker = Unit(
            ...
            pos=(2, 2),
            facing="N",
            stats=UnitStats(hp=20, atk=10, def_=2, h=1),
            team="player"
        )
        ...
        self.target = Unit(
            ...
            pos=(3, 3),
            facing="S",
            stats=UnitStats(hp=15, atk=6, def_=3, h=0),
            team="enemy"
        )
    ...
    def test_damage_floors_at_zero(self):
        ...
        weak_attacker = Unit(
            ...
            pos=(1, 1), 
            facing="N",
            stats=UnitStats(hp=10, atk=2, def_=1, h=0),
            team="player"
        )
        ...
        strong_defender = Unit(
            ...
            pos=(1, 2),
            facing="S", 
            stats=UnitStats(hp=20, atk=8, def_=10, h=0),
            team="enemy"
        )
    ...
    def test_hp_floors_at_zero(self):
        ...
        massive_attacker = Unit(
            ...
            pos=(1, 1),
            facing="N", 
            stats=UnitStats(hp=20, atk=100, def_=0, h=5),
            team="player"
        )
...
class TestCombatIntegration:
    ...
    def test_multiple_attacks(self):
        ...
        attacker = Unit(
            "attacker", (1, 1), stats=UnitStats(hp=20, atk=8, def_=2),
            team="player"
        )
        target = Unit(
            "target", (2, 2), stats=UnitStats(hp=20, atk=6, def_=3), 
            team="enemy"
        )
    ...
    def test_height_and_facing_combined(self):
        ...
        high_attacker = Unit(
            "high", (1, 1), facing="N",
            stats=UnitStats(hp=20, atk=8, def_=2, h=3),
            team="player"
        )
        ...
        low_target = Unit(
            "low", (3, 3), facing="S",
            stats=UnitStats(hp=20, atk=6, def_=3, h=0),
            team="enemy"
        )
