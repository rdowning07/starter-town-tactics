...
import pygame
from game.status_effects import StatusEffectManager, StatusEffect
from game.ui.status_ui import StatusUI
from game.fx_manager import FXManager, FXType, FXEffect
...
class TestWeek4Coverage(unittest.TestCase):
    ...
    def test_status_effects_logger_integration(self):
        ...
        logger.log_event.assert_called_with("status_effect_added", {
            "unit": "player_1",
            "effect": "poison",
            "duration": 3,
            "stacks": 1
    ...
    def test_status_ui_effect_at_position(self):
        ...
        # Mock status manager
        status_manager = Mock()
        status_manager.get_unit_effects.return_value = [
            StatusEffect(name="poison", duration=3, effect_type="debuff")
        ]
