...
class EnhancedRenderer:
            ...
            for x in range(grid_width):
                ...
                if terrain_sprite:
                    ...
                    pygame.draw.rect(
                        self.screen,
                        color,
                        (x * self.tile_size, y * self.tile_size, self.tile_size - 1, self.tile_size - 1),
                    )
    ...
    def _draw_ui_overlay(self, game_state) -> None:
        ...
        if panel_sprite:
            ...
            # Fallback: colored rectangle
            pygame.draw.rect(self.screen, (32, 32, 48), (panel_x, panel_y, panel_width, panel_height))
            pygame.draw.rect(self.screen, (128, 128, 128), (panel_x, panel_y, panel_width, panel_height), 2)
