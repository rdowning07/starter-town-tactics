...
class UIAssetDemo:
    ...
    def draw_step_3_turn_indicators(self):
        ...
        # Show turn info
        turn_text = (
            f"Turn: {getattr(self.game_state.sim_runner, 'turn_count', 0)} | Current: {self.ui_state.selected_unit}"
        )
    ...
    def _draw_demo_units(self):
        ...
        for unit_id, unit_data in self.game_state.units.units.items():
            ...
            pygame.draw.rect(
                self.screen, (255, 255, 255), (screen_x + 8, screen_y + 8, tile_size - 16, tile_size - 16), 2
            )
