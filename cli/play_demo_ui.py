...
from game.ui.input_handler import handle_mouse_input, handle_keyboard_input
...
def create_demo_game_state():
    ...
    game_state.units.register_unit("player_1", "player", hp=20, max_hp=20, x=2, y=2)
    game_state.units.register_unit("player_2", "player", hp=15, max_hp=15, x=3, y=3)
    game_state.units.register_unit("enemy_1", "enemy", hp=18, max_hp=18, x=5, y=5)
    game_state.units.register_unit("enemy_2", "enemy", hp=12, max_hp=12, x=6, y=6)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE or event.key == pygame.K_q:
                    ...
                    fx_manager.trigger_status_apply_fx((unit_data.get("x", 0) * tile_size, 
                                                       unit_data.get("y", 0) * tile_size), "debuff")
                    ...
                    unit_data = game_state.units.units.get(target_unit, {})
                    fx_manager.trigger_status_apply_fx((unit_data.get("x", 0) * tile_size, 
                                                       unit_data.get("y", 0) * tile_size), "buff")
